...
public:
  ...
  public:
    /// Patch
    shared_ptr<FuzzFlow::Scope> scope = nullptr;
    /// Patch
    shared_ptr<FuzzFlow::VarSymbol> function_symbol = nullptr;

    /// Patch:
    /// This is used for passing data between multiple visit of the ast.
    /// For example, RefResolverError creates builtin symbols. IRGenerator creates BuiltinNode according to these symbols.
    std::set<shared_ptr<FuzzFlow::Symbol>> builtin_symbols;
  ...
  public:
    /// Patch: add var_symbol for declaration
    shared_ptr<FuzzFlow::VarSymbol> var_symbol = nullptr;
  ...
  public:
    /// Patch: Add an l-value flag to distinguish between Store and Load operations
  ...
  public:
    ...
    /// Patch: established in resolve phase
    shared_ptr<FuzzFlow::Symbol> symbol = nullptr;
