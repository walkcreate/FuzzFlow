#include "MaterialSpiderMonkey.h"

namespace FuzzFlow {

pair<string,string> prefix_suffix_pair_sm = {
    /// code prefix
    R"(
...
vector<pair<string, string>> MaterialSpiderMonkey::prefix_suffix_pairs {
    prefix_suffix_pair_sm
};
